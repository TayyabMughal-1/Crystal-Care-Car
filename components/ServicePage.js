...
export default function ServicePage({ service }) {
  ...
  return (
    <Layout>
      <Head>
        <title>{service.title} in Islamabad &amp; Rawalpindi | Crystal Car Wash</title>
        ...
        <div className="container service-detail">
            ...
            <div className="process">
              {service.process.map((step, index) => (
                <div className="step" key={step}>
                  ...
                  <div>
                    <h4>{step}</h4>
                    <p>We handle this step carefully so the final result looks clean, professional, and ready for daily use.</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <aside className="side-panel">
            ...
            <p style={{ color: 'var(--muted)', lineHeight: 1.7 }}>
              Send your car type, area, and preferred time. We will confirm the right service and quotation.
            </p>
            <div className="actions" style={{ marginTop: 18 }}>
              <Link href="/contact" className="btn btn-primary">Book This Service</Link>
