...
export default function About() {
  return (
    <Layout>
      <Head>
        <title>About Us | Crystal Car Care</title>
        <meta
          name="description"
          content="Crystal Car Care is a professional car wash and detailing brand serving Islamabad and Rawalpindi with clean, convenient, premium service."
        />
      </Head>
      <PageHero
        title="About Crystal Car Care"
        ...
        <div className="container split">
          <div>
            ...
            <p style={{ color: "var(--muted)", lineHeight: 1.8 }}>
              Crystal Car Care is designed for daily drivers, families, office
              staff, and corporate fleets. The website presents each service
              clearly so customers can understand what they need and book with
              confidence.
            </p>
