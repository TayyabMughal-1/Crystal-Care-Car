...
export default function Services() {
  return (
    <Layout>
      <Head>
        <title>All Services | Crystal Car Care</title>
        <meta
          name="description"
          content="Car wash, detailing, paint protection, restoration, packages, and corporate services from Crystal Car Care in Islamabad and Rawalpindi."
        />
      </Head>
      <PageHero
